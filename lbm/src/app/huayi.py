...
class huayi(base_app):
    ...
    def set_inlets(self, lattice, it):
        ...
        lattice.u_top[0,:]   = ret*self.u_lbm
        lattice.u_bot[0,:]   = 0.0
    ...
    def outputs(self, lattice, it):
        ...
        plot_cavity_validation(lattice, self.dpi, it)
        # if (it>self.it_max-self.output_freq):
        #     plot_cavity_validation(lattice, self.dpi)
